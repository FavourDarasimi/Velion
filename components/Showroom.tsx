      ...
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-10 grid items-stretch gap-4 sm:gap-5 lg:grid-cols-2">
          ...
          >
            ...
            <ul className="mt-6 divide-y divide-[#E2E8F0]">
              {CHECKS.map((c) => (
            ...
            <p className="mt-6 rounded-xl bg-[#F1F5F9] px-4 py-3 text-sm text-[#475569]">
        ...
        <div
          data-reveal
          className="mt-4 grid divide-y divide-[#E2E8F0] rounded-2xl border border-[#E2E8F0] bg-white sm:mt-5 sm:grid-cols-3 sm:divide-x sm:divide-y-0"
        >
          <div className="p-6 sm:p-7">
            <p className="font-mono text-[11px] tracking-[0.24em] text-[#64748B] uppercase">
              Visit
            </p>
            <p className="font-display mt-3 text-xl font-semibold tracking-tight text-[#0F172A]">
              Kantstraße 7, Berlin
            </p>
            <a
              ...
              className="mt-2 inline-block text-sm font-semibold text-[#0F172A] underline decoration-[#CBD5E1] decoration-2 underline-offset-4 transition-colors hover:decoration-[#0F172A] focus-visible:ring-2 focus-visible:ring-[#0F172A] focus-visible:outline-none"
            >
              Get directions
            </a>
          </div>
